...
# kernel sources live one directory up (accel/cuda/); resolve relative to this file.
_CUDA_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
mha_cuda = load(
    name='mha_cuda',
    sources=[os.path.join(_CUDA_DIR, "kernels.cu"), os.path.join(_CUDA_DIR, "bindings.cpp")],
    verbose=True,
)
